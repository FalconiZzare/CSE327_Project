...
export function HomeButton() {
  return (
    <Link
      href="/"
      className="group lg:border-border lg:bg-background lg:hover:border-border lg:hover:bg-accent absolute top-5 right-5 z-20 flex items-center gap-2 rounded-full border border-white/20 bg-black/35 px-4 py-2 backdrop-blur-sm transition-all duration-200 hover:border-white/35 hover:bg-black/55 lg:top-8 lg:backdrop-blur-none"
    >
      <House
